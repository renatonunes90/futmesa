...
/**
 * Enum de tipos de campeonatos.
 */
public enum ChampionshipType
{

   FREE_FOR_ALL( 0, "Todos Contra Todos" ), CLASSIFICATORY_GROUPS( 1, "Classificatório Grupos" ), CLASSIFICATORY_DEATHMATCH( 2, "Classificatório Mata-Mata" );
